...
{
	[TableInformation(TableName = "Production.ProductCostHistory")]
	[Serializable]
	public partial class ProductCostHistory: INotifyPropertyChanged
	{
		...
		[RelationInformation(IsEntityParent=false, ParentTableName = "Production.Product", ChildTableName = "Production.ProductCostHistory", ParentColumnNames = new[]{ "ProductID" }, ChildColumnNames =  new[]{ "ProductID" } , PropertyNames = new[]{ "ProductID" }, ForeignFieldNames =  new[]{ "_productID" } )]
